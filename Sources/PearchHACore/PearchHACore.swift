...
public struct PearchHAHistoryCursorSample: Equatable, Sendable {
    public let timestamp: Date
...
public enum PearchHAHistoryCursor {
    ...
    public static func numericSamples(of series: HistorySeries) -> [PearchHAHistoryCursorSample] {
        series.samples.enumerated()
            .compactMap { index, sample -> (Int, PearchHAHistoryCursorSample)? in
                guard let value = sample.numericValue else {
                    return nil
                }
                return (index, PearchHAHistoryCursorSample(timestamp: sample.timestamp, value: value))
            }
            .sorted { lhs, rhs in
    ...
    ///   numeric samples.
    public static func nearestSample(in series: HistorySeries, atNormalizedX normalizedX: Double) -> PearchHAHistoryCursorSample? {
    ...
    public static func nearestSample(in samples: [PearchHAHistoryCursorSample], atNormalizedX normalizedX: Double) -> PearchHAHistoryCursorSample? {
...
public enum PearchHAServiceLabel {
...
public enum PearchHARoomSearch {
...
public enum PearchHACore {
    public static let module = PearchHAModule(
        name: "PearchHACore",
        responsibility: "Pure domain state and behavior for PearchHA."
    )
}
