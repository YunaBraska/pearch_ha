...
public enum PearchHAEntityAveraging {
...
public enum EntityDisplayDefaults {
    public struct SemanticStateThresholdLegendItem: Equatable, Sendable, Identifiable {
        ...
        public init(id: String, label: String, color: PearchHAAccentColor) {
            self.id = id
            self.label = label
            self.color = color
        }
    ...
    public static func semanticStateColor(for state: String) -> PearchHAAccentColor {
    ...
    /// Applies the entity's current default threshold palette when the stored
