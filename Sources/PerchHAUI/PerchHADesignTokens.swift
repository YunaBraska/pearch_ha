...
/// The PerchHA corner-radius scale for the three nesting levels of surface.
///
...
public enum PerchHACornerRadius {
...
/// The PerchHA typography helpers.
///
...
/// The PerchHA motion tokens and reduce-motion-aware animation helper.
///
