...
struct PearchHAConnectionTokenAccessPresentation: Equatable {
...
struct PearchHAEntityMetadataPresentation: Equatable {
...
struct PearchHAEntityMetadataLinksPresentation: Equatable {
    let entitiesURL: URL?
    let deviceURL: URL?
...
struct PearchHASettingsEntityPresentation: Equatable {
    let metadata: PearchHAEntityMetadataPresentation
