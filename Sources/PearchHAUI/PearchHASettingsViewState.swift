...
@MainActor
final class PearchHASettingsViewState: ObservableObject {
    ...
    @Published private(set) var releaseUpdateState: PearchHAReleaseUpdateState
    @Published private(set) var retryBackoffState: PearchHARetryBackoffState
    @Published private(set) var diagnosticEvents: [PearchHADiagnosticEvent]
    ...
    private var activeTab: PearchHASettingsView.Tab = .connection
    ...
    func setActiveTab(_ tab: PearchHASettingsView.Tab) {
    ...
    func presentation(for entity: DiscoveredEntity, roomName: String) -> PearchHASettingsEntityPresentation {
        PearchHASettingsEntityPresentation(
            metadata: PearchHAEntityMetadataPresentation(entity: entity, roomName: roomName),
    ...
    private func shouldAcceptSnapshotUpdate(
        from previous: PearchHAPanelSnapshot,
        to next: PearchHAPanelSnapshot
    ) -> Bool {
        switch activeTab {
        case .connection:
