...
public struct PearchHAApplicationVersionInfo: Equatable, Sendable {
    ...
    public static func fromInfoDictionary(_ info: [String: Any]?) -> PearchHAApplicationVersionInfo {
        PearchHAApplicationVersionInfo(
            marketingVersion: info?["CFBundleShortVersionString"] as? String,
            buildVersion: info?["CFBundleVersion"] as? String
        )
    }

    public static func currentBundle() -> PearchHAApplicationVersionInfo {
