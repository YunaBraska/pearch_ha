...
public enum PearchHACoverageCheckCommand {
    ...
    public static func run(
        ...
        do {
            ...
            standardError("pearchha-coverage-check: \(error)\n")
            return 1
        }
    }
}
...
enum CoverageCheckError: Error, Equatable, CustomStringConvertible {
    ...
    static let help = """
    Usage:
      pearchha-coverage-check --coverage-json PATH --line-target PearchHACore=95 --line-target PearchHAClient=95 --branch-target PearchHACore=90
    """
}
