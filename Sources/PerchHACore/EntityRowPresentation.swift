...
public enum PerchHAEntityRowPresentation: Equatable, Sendable {
    case gauge(PerchHAEntityGauge)
    ...
    private static func gaugeStyle(for style: MenuBarDisplayStyle) -> PerchHAGaugeStyle {
        switch style {
        case .ring, .text:
            .ring
        case .bar:
...
public enum PerchHAGaugeStyle: String, Equatable, Sendable {
    case ring
    case bar
    case battery
}
...
/// drawn shape.
public struct PerchHAEntityGauge: Equatable, Sendable {
    ...
    public let style: PerchHAGaugeStyle

    public init(fraction: Double, severity: ValueSeverity, style: PerchHAGaugeStyle) {
