...
public struct PearchHAGitHubReleaseUpdateChecker: Sendable {
    ...
    public func checkLatest(currentVersion: String) async -> PearchHAReleaseUpdateCheckResult {
        ...
        request.setValue("PearchHA/\(normalizedCurrentVersion)", forHTTPHeaderField: "User-Agent")
