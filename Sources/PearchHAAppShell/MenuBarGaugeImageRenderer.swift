...
@MainActor
public protocol PearchHAStatusItemGaugeImageRendering {
    func image(for item: RenderedMenuBarItem) -> NSImage?
}

@MainActor
public struct PearchHAStatusItemGaugePalette {
    ...
    public static var system: PearchHAStatusItemGaugePalette {
        PearchHAStatusItemGaugePalette(
...
@MainActor
public struct PearchHAStatusItemGaugeImageRenderer: PearchHAStatusItemGaugeImageRendering {
    public let size: NSSize
    public let palette: PearchHAStatusItemGaugePalette

    public init(
        size: NSSize = NSSize(width: 24, height: 18),
        palette: PearchHAStatusItemGaugePalette = .system
    ) {
        self.size = size
...
@MainActor
public struct PearchHAStatusItemLogoImageRenderer {
    ...
    private func draw(in bounds: NSRect) {
        ...
        // The shape mirrors the Pearch brand mark: a right-facing pearch with
        ...
        // Dorsal fin: the pearch's spiky crest along the top of the back.
